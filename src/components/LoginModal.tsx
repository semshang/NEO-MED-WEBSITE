      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-[900px] bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden z-10 h-auto max-h-[90vh] md:h-[600px]"
          >
            {/* Close Button */}
            <button 
              onClick={handleClose}
            ...
            <div className="hidden md:flex flex-col w-1/2 bg-gradient-to-br from-[#e8f1f9] to-[#d1e3f3] p-10 relative overflow-hidden">
              ...
              <div 
                ...
                style={{ 
                  backgroundImage: 'radial-gradient(#1A2B3C 1.5px, transparent 1.5px)', 
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                {/* Product Platforms */}
                <div className="mt-auto flex-1 relative flex items-end justify-center pb-12 pt-8 min-h-[140px]">
                  {/* Platform 1 (Left) */}
                  <div className="absolute bottom-10 left-2 w-24 h-10 bg-[#b6d4e8] rounded-[50%] shadow-[0_8px_16px_rgba(0,0,0,0.1)]"></div>
                  {/* Platform 2 (Center) */}
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-36 h-14 bg-[#a3c9e2] rounded-[50%] shadow-[0_12px_24px_rgba(0,0,0,0.15)] z-10"></div>
                  {/* Platform 3 (Right) */}
                  <div className="absolute bottom-12 right-2 w-20 h-8 bg-[#c4e0f0] rounded-[50%] shadow-[0_6px_12px_rgba(0,0,0,0.08)]"></div>
                  ...
                  <div className="relative z-20 flex items-end justify-center w-full space-x-2">
                    <img 
                      ...
                      className="w-20 object-contain mb-10 relative z-10 drop-shadow-md"
                      onError={(e) => { e.currentTarget.style.display = 'none'; }}
                    />
                    <img 
                      src="/products/patient-monitor.png" 
                      alt="Patient Monitor" 
                      className="w-32 object-contain mb-8 relative z-20 drop-shadow-xl"
                      onError={(e) => { e.currentTarget.style.display = 'none'; }}
                    />
                    <img 
                      src="/products/infusion-pump.png" 
                      alt="Infusion Pump" 
                      className="w-16 object-contain mb-12 relative z-10 drop-shadow-md"
                      onError={(e) => { e.currentTarget.style.display = 'none'; }}
                    />
                  </div>
                </div>
                ...
                {/* Floating Badge */}
                <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg flex items-center space-x-3 border border-white/50 max-w-[85%] z-30">
            ...
            {/* Right Panel (Auth) */}
            <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col relative bg-white">
              <div className="flex-1 flex flex-col items-center justify-center">
                <div className="w-full max-w-[320px] flex flex-col items-center">
                  ...
                  <p className="text-sm text-slate-500 mt-2 mb-12 text-center">Sign in to access your account</p>
              ...
              {/* Secure Footer */}
              <div className="mt-auto w-full pt-6 border-t border-slate-100 flex items-center justify-center space-x-1.5 text-slate-400">
                <ShieldCheck size={14} />
