      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-[1000px] bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden z-10 min-h-[600px] max-h-[95vh]"
          >

            {/* Left Panel (Marketing) */}
            <div className="hidden md:flex flex-col w-1/2 bg-[#eff5f9] p-12 relative overflow-hidden">
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-center space-x-2.5 mb-12">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[#0d52bc] font-black tracking-widest leading-none text-base">NEOMEDITECH</span>
                    <span className="text-slate-400 font-semibold text-[9px] tracking-[0.2em] uppercase mt-0.5">Biomedical Solutions</span>
                  </div>
                </div>
                
                <h2 className="text-[34px] font-extrabold text-brand-navy leading-tight mb-2">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col relative bg-white">
              ...
              <div className="flex-1 flex flex-col justify-center w-full max-w-[380px] mx-auto mt-6">
                ...
                <h3 className="text-[28px] font-bold text-brand-navy mb-1 tracking-tight">Welcome Back</h3>
                <p className="text-[13px] text-slate-500 mb-8">Sign in to access your account</p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="email" placeholder="Enter your email" className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-[#0d52bc] focus:ring-1 focus:ring-[#0d52bc] transition-all text-sm" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="password" placeholder="Enter your password" className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-[#0d52bc] focus:ring-1 focus:ring-[#0d52bc] transition-all text-sm" />
                    ...
                    <div className="flex justify-end mt-1.5">
                      <a href="#" className="text-[11px] text-[#0d52bc] font-bold hover:underline">Forgot Password?</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center mt-1 mb-6">
                    ...
                    <label htmlFor="remember" className="ml-2 text-[11px] text-slate-600 font-medium">Remember me</label>
                  </div>
                  ...
                  <div className="relative flex items-center py-5">
                    ...
                    <span className="flex-shrink-0 mx-4 text-slate-400 text-[11px] font-medium">or continue with</span>
                    <div className="flex-grow border-t border-slate-100"></div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button onClick={() => alert("Microsoft login not configured")} className="flex items-center justify-center space-x-2 border border-slate-200 rounded-xl py-2 hover:bg-slate-50 transition-colors">
                      ...
                      <span className="text-[11px] font-bold text-slate-700">Continue with Microsoft</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col items-center">
                  ...
                  <div className="flex items-center space-x-1.5 text-slate-400">
                    <ShieldCheck size={14} />
                    <span className="text-[10px] font-medium">Your data is secure and encrypted</span>
                  </div>
                </div>
