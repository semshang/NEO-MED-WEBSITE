      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div 
            ...
            animate="visible"
            exit="exit"
            className="relative w-full max-w-5xl bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden my-auto max-h-full"
          >
            {/* Close Button */}
            <button 
              onClick={closeModal}
            ...
            <motion.div variants={leftPanelVariants} className="hidden md:flex flex-col w-1/2 bg-[#eff5f9] p-6 lg:p-8 relative overflow-hidden">
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mt-auto relative w-full flex-1 flex flex-col justify-end min-h-[160px] lg:min-h-[200px]">
                  <motion.img 
                    initial={{ y: 0 }}
                    animate={{ y: [-5, 5, -5] }}
