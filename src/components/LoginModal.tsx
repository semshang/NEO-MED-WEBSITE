      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            {/* Right Panel (Auth) */}
            <motion.div variants={rightPanelVariants} className="w-full md:w-1/2 p-6 md:p-10 flex flex-col relative bg-white">
              
              {/* Top Right Controls */}
              <motion.div variants={formItemVariants} className="absolute top-6 right-6 flex items-center space-x-4">
              ...
              <div className="flex-1 flex flex-col justify-center w-full max-w-[360px] mx-auto mt-4">
                ...
                <div className="space-y-3">
                  ...
                  <motion.div variants={formItemVariants}>
                    <button onClick={handleSignIn} disabled={isLoading} className="w-full flex items-center justify-center space-x-2 border border-slate-200 rounded-xl py-2.5 hover:bg-slate-50 transition-colors disabled:opacity-50">
                      {isLoading ? (
                        ...
                        <svg className="w-4 h-4 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
